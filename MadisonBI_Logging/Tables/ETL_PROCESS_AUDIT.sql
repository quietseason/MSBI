...
(
	[ETL_PROCESS_AUDIT_ID] BIGINT NOT NULL IDENTITY(1,1),
	...
	CONSTRAINT [FK_ETL_PROCESS_AUDIT_ETL_PROCESS_LOG_ID] FOREIGN KEY(ETL_PROCESS_LOG_ID) REFERENCES DBO.ETL_PROCESS_LOG(ETL_PROCESS_LOG_ID) ON DELETE CASCADE,
